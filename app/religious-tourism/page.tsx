...
export const metadata: Metadata = { title: "Muslim Religious Tourism Planner | NOOR", description: "Build a respectful Muslim travel plan with destination guidance, prayer preparation, packing and a private checklist." };

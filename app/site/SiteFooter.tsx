  ...
  return (
    <footer className="professional-footer">
      <div className="professional-footer-main">
        ...
        <div><strong>Learn</strong><Link href="/topics/ahle-sunnat">Ahle Sunnat</Link><Link href="/topics/pillars">Five Pillars</Link><Link href="/firozul-lughat">Firoz-ul-Lughat</Link><Link href="/topics/faqs">Islamic FAQs</Link></div>
        ...
        <div><strong>Explore</strong><Link href="/mosque-finder">Mosque Finder</Link><Link href="/destinations">Muslim Destinations</Link><Link href="/religious-tourism">Religious Tourism</Link><Link href="/shop">Shop by Category</Link></div>
      </div>

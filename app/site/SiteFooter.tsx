  ...
  return (
    <footer className="professional-footer">
      <div className="professional-footer-main">
        ...
        <div><strong>Daily</strong><Link href="/quran">Quran</Link><Link href="/namaz">Prayer & Wudu</Link><Link href="/qibla">Qibla Compass</Link><Link href="/islamic-calendar">Islamic Calendar</Link></div>
        ...
        <div><strong>Library & Community</strong><Link href="/naat">Naat & Salam</Link><Link href="/topics/scholars">Scholars</Link><Link href="/topics/institutes">Institutes</Link><Link href="/matrimony">Matrimony</Link></div>
      </div>

...
export default function FamilyTreePage() {
  return (
    <main className="family-page" id="top">
      ...
      <section className="family-sources" id="sources"><div><p className="eyebrow">READ & VERIFY</p><h2>Sources and editorial boundaries</h2><p>The Qur’an establishes the special status of the Prophet ﷺ and the Mothers of the Believers. Family names and relationships are presented from widely used seerah summaries, while detailed genealogical disputes remain outside this compact view.</p></div><div><a href="https://quran.com/33/6" target="_blank" rel="noreferrer"><span>QURAN 33:6</span><strong>The Prophet’s wives are Mothers of the Believers</strong></a><a href="https://quran.com/33/40" target="_blank" rel="noreferrer"><span>QURAN 33:40</span><strong>Muhammad ﷺ is the Messenger of Allah and seal of the prophets</strong></a><a href="https://sunnah.com/bukhari:3714" target="_blank" rel="noreferrer"><span>SAHIH AL-BUKHARI 3714</span><strong>The virtue of Fatimah رضي الله عنها</strong></a><Link href="/topics/family-tree"><span>NOOR FULL GUIDE</span><strong>Open the detailed lineage notes and review policy</strong></Link></div></section>

...
export const metadata: Metadata = { title: "Famous Muslim Destinations | NOOR", description: "Explore sacred cities, Islamic learning centres, Sufi heritage and historic Muslim destinations in one internal guide." };
